...
// Source: internal/address/addressclient/client.go
...
func (m *MockClient) GetAddress(ctx context.Context, req *entities.GetAddressRequest) (*entities.Address, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAddress", ctx, req)
...
func (mr *MockClientMockRecorder) GetAddress(ctx, req interface{}) *gomock.Call {
