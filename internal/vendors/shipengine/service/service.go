...
import (
	...
	moduleErrors "github.com/nurdsoft/nurd-commerce-core/internal/vendors/shipengine/errors"
	shipengineErrors "github.com/nurdsoft/nurd-commerce-core/internal/vendors/shipengine/errors"
	"go.uber.org/zap"
)
...
func New(httpClient *http.Client, config config.Config, logger *zap.SugaredLogger) (Service, error) {
