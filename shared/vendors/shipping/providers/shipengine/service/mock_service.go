...
// Source: shared/vendors/shipping/providers/shipengine/service/service.go
...
func (m *MockService) ValidateAddress(ctx context.Context, address entities.Address) error {
	m.ctrl.T.Helper()
